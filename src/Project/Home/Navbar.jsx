...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-md">
      ...
      <div className="container mx-auto flex justify-between items-center bg-[#0f172a] p-2 md:p-3">
        ...
        {/* <div className="flex space-x-4">
          <a href="/orderlist">
          <FontAwesomeIcon icon={faRectangleList} className="text-white text-2xl md:text-3xl"/>
          <span className="text-white text-sm">Order List</span>
          </a>
          <a href="/cartproduct" className="relative">
      <FontAwesomeIcon 
        icon={faCartShopping} 
    ...
    <a href="/login" title="Login">
      <FontAwesomeIcon 
        icon={faCircleUser} // Use the imported icon here
        className="text-2xl md:text-3xl text-white" 
      />
...
<div className="flex space-x-4">
  ...
  <a href="/cartproduct" className="flex flex-col items-center relative" >
    <FontAwesomeIcon 
      icon={faCartShopping} 
      className="text-2xl md:text-3xl text-white" 
    />
